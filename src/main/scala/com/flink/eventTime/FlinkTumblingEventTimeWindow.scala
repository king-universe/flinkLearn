...
/**
  ...
  * @version 1.0
  */
object FlinkTumblingEventTimeWindow {
  def main(args: Array[String]): Unit = {
    ...
    val windowStream: WindowedStream[(String, Long, Int), Tuple, TimeWindow] =textKeyedStream.window(TumblingEventTimeWindows.of(Time.seconds(2)))
